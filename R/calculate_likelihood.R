#' @title Calculate the likelihood at a certain position.
#' 
#' 
#' 
...
#'    
#'    
#' @return Returns the likelihood for a position in parameter space.

calculate_likelihood = function(output, options, position=NULL){
  if (is.null(position)){
    position=output$position
  }
  return(options$likelihood_fn(position))
}
