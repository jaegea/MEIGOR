...
#' 
#' @title Run MCMC algorithm
#' 
#' @description Initialize internal state and runs the parameter estimation.
#' 
#' 
...
#' 
#' 
#' @return output: The updated output list after the initialization and estimation -- list with entries as explained in 'Arguments'.
#' 
run = function(output, options){
  output = initialize(output, options)
  output = estimate(output, options)
}