#' @title Reject the current proposed move.
#' 
#' @description "reject_move" updates the output list after accepting the current proposed move.
#' 
...
#'    
#' @return The updated output after the move is rejected -- list with entries as explained in 'Arguments'.
#'    
#'    
#' 
reject_move = function(output){
  output$rejects[output$iter]=TRUE
  return(output)
}