...
\title{
	...
	\affil[1]{Centro de Edafología y Biología Aplicada del Segura, Murcia, Spain}
	\affil[2]{Instituto de Investigaciones Marinas-CSIC, Vigo, Spain}
	\affil[3]{Institute Pasteur, Paris, France}
	\affil[4]{Universität Heidelberg, Saez-Rodriguez group, Heidelberg, Germany}
...
<<label=CellNOptR_example_fig_model_plot,include=TRUE,echo=FALSE,results='hide'>>=
